    ...
    return (
        <div className='flex flex-col w-full h-full px-10 py-6 font-mulish'>
            <div className='flex relative justify-center'>
                ...
                <div className='flex absolute bottom-[-25px] items-center h-[60px] w-auto py-2 px-6 rounded-md bg-cardWhite shadow-md'>
            ...
            <div className='flex flex-row w-full h-full justify-between mt-20 font-mulish'>
                <div className='flex flex-col w-[17%] h-[490px] bg-darkGray rounded-md shadow-md py-4 justify-evenly'>
                    <div className='flex flex-col px-10 w-full h-[100px] justify-evenly'>
